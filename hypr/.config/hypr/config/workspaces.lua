...
hl.workspace_rule({ workspace = "10", monitor = MONITOR2, persistent = true })
hl.workspace_rule({ workspace = "11", monitor = MONITOR3, default = true, persistent = true })
hl.workspace_rule({ workspace = "12", monitor = MONITOR3, persistent = true })
